<div class="container">
  <div class="list-group sidebar-left" style="text-align:center;float:left">
    ...
    <div style="width:50%">
      <a href="#" class="list-group-item list-group-item-action">英文</a>
      <a href="#" class="list-group-item list-group-item-action">日文</a>
      <a href="#" class="list-group-item list-group-item-action">韓文</a>
      <a href="#" class="list-group-item list-group-item-action">德文</a>
      <a href="#" class="list-group-item list-group-item-action">法文</a>
